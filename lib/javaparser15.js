...
function peg$parse(input, options) {
  ...
  function peg$parseLambdaParameter() {
    var s0;

    s0 = peg$parseFormalParameter();
    if (s0 === peg$FAILED) {
  ...
  function peg$parseLastLambdaParameter() {
    var s0;
  ...
  function peg$parseLambdaParameterList() {
    var s0, s1, s2, s3, s4, s5;

    s0 = peg$currPos;
    s1 = peg$parseLambdaParameter();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parseCOMMA();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseLambdaParameter();
        if (s5 !== peg$FAILED) {
          s4 = [s4, s5];
          s3 = s4;
        } else {
      ...
      if (s2 !== peg$FAILED) {
        ...
        s4 = peg$parseCOMMA();
        if (s4 !== peg$FAILED) {
          s5 = peg$parseLastLambdaParameter();
          if (s5 !== peg$FAILED) {
            s4 = [s4, s5];
            s3 = s4;
          } else {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$currPos;
      s1 = peg$parseLastLambdaParameter();
      if (s1 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c42(s1);
      }
